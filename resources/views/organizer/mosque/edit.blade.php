<x-organizer-layout>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm max-w-4xl mx-auto">
        <form action="{{ route('organizer.mosque.update', $mosque->id) }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-8 border-b border-gray-200 pb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        @if($mosque->photo)
                            <div class="mb-3">
                                <img src="{{ asset('storage/'.$mosque->photo) }}" class="h-32 w-auto rounded-lg border border-gray-200 shadow-sm">
                            </div>
                        @endif
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="url" name="google_maps_url" id="google_maps_url" class="w-full rounded-md border-gray-300 shadow-sm focus:border-brand-emerald-900 focus:ring focus:ring-brand-emerald-900 focus:ring-opacity-50" value="{{ old('google_maps_url', $mosque->google_maps_url) }}">
