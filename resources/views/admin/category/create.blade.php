    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
        <form action="{{ route('admin.category.store') }}" method="POST" class="p-6 sm:p-8">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" id="name" class="w-full rounded-md border-gray-300 shadow-sm focus:border-brand-emerald-900 focus:ring focus:ring-brand-emerald-900 focus:ring-opacity-50" required placeholder="Contoh: Fiqih" value="{{ old('name') }}">
