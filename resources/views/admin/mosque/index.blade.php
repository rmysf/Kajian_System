            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50/50 transition">
                        <td class="px-6 py-4 text-sm text-brand-ink font-medium">{{ $mosque->name }}</td>
                    ...
                    @if($mosques->isEmpty())
                    <tr class="hover:bg-gray-50/50 transition">
                        <td colspan="3" class="px-6 py-4 text-sm text-gray-500 text-center">Belum ada data masjid.</td>
                    </tr>
                    @endif
                </tbody>
            </table>
